...
func (s Severity) String() string {
    switch s {
        ...
        default : panic(os.NewError("syslog: Invalid Severity values"))
    }
    return ""
}
...
func (s *SyslogMsg) SSetTimestamp(stamp string) os.Error {
    time, err := time.Parse(TimestampFmt, stamp)
...
func (s *SyslogMsg) Send(ip string) os.Error {
    var addr net.IP
